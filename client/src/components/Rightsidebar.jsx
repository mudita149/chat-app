...
const Rightsidebar = () => {
  ...
  // get all images from msgs and send them to state
  useEffect(() => {
    setMsgImages(
  ...
  return selectedUser && (
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? 'max-md:hidden' : ''
      ...
      {/*----user's image as first thing to display-------*/}
      ...
      <div className="px-5 text-xs">
        ...
        <div className="mt-2 max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80">
          {msgImages.map((url, index) => ( /* when you click on a photo it opens in a new  window*/
