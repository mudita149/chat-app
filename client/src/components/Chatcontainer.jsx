...
const Chatcontainer = () => {
    ...
    useEffect(() => {
        if (scrollEnd.current && messages) {
            // FIX 9: 'behaviour' → 'behavior' (Web API uses American English)
            scrollEnd.current.scrollIntoView({ behavior: "smooth" });
        }
        // FIX 10: pass messages as dependency so scroll fires on every new message
    }, [messages]) // TODO: replace [] with [messages] once component is wired to real API data
